...
namespace SocialNetwork.PLL.Views
{
    public class MessageSendingView
    {
        ...
        public void Show(User user) //в параметре данные того кто сейчас зашел в профиль, т.е. того кто отправляет сообщение
        {
            ...
            messageSendingData.SenderId = user.Id; //в класс "данные отправителя" записывается ID отправителя, собственно
